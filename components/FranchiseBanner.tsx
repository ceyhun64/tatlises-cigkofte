...
export default function FranchiseBanner() {
  return (
    <div className="bg-brand-red py-2 px-4">
      <div className="max-w-5xl mx-auto flex flex-wrap items-center justify-center gap-2 text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-1 text-white text-[11px] font-bold underline underline-offset-2 hover:opacity-75 transition-opacity"
        >
